...
//
//        // showDown
//        print("It's show down")
//
//        // First, check to see that another showDown is even playable...
//
//        // If both players have at least one cards, a war is possible
//        if player.cards.count >= 4 && computer.cards.count >= 1 {
//
//            // show down
//
//            // Build the bounty
